...
![Runtime dropdown](../docs/assets/screenshots/overlay-runtime.png)
...
![Compose tab](../docs/assets/screenshots/compose-tab.png)

![Edit prompt modal](../docs/assets/screenshots/edit-route-prompt.png)
...
![Context state tab](../docs/assets/screenshots/context-state-tab.png)

**Debug trace panel.** System prompt, user prompt, active context, every
attempt, and the resolved config — live-updated per run.

![Debug trace](../docs/assets/screenshots/debug-trace-1.png)

![Debug trace continued](../docs/assets/screenshots/debug-trace-2.png)
...
- [`export_library.py`](export_library.py) — named `.py` export store.
